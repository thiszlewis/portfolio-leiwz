const ProjectsData = [
  ...
  },
  {
    ...
    description:
      "Analyzing Json Crime Data into a map for Visualizing the major data analysis is done in python",
  ...
  },
  {
    ...
    description:
      "A python csv analysis library i built for filtering data out of large csv files with the use of numpy and pandas dataFrame. 50 people currently use this library.",
  ...
  },
  {
    ...
    description:
      "Qlik deCODE Hackathon 2017 - Visualize the commitments that various countries made in accordance to the United Nations SDG 14 #saveourocean movement.",
  ...
  },
  {
    ...
    description:
      "View and Explore all traffic light cameras in the city of ottawa with google maps and an effective searching algorithm. Note camera images refresh after every 60 seconds. if an image is requested more than once within the 60 seconds no image is displayed",
